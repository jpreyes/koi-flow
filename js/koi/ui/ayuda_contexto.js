...
const HELP = {
  ...
  hidrologia: { t: 'Hidrología del punto', d: 'Todo el análisis hidrológico de un punto: delinea la cuenca aportante y su morfometría, elige las estaciones DGA, corre el pipeline (frecuencia → PP → caudales, con transposición fluviométrica) y, en el cruce, el eje-sección y la socavación.',
    insumos: ['Un punto de análisis (menú GIS)', 'Relieve (DEM) del sector', 'Estaciones DGA cercanas', 'CN, zona, período T'],
    normas: ['Delineación D8', 'Frecuencia (6 distribuciones)', 'Racional / Verni-King / DGA / HU Linsley', 'Transposición (zona árida)'],
    pasos: ['Cuenca / relieve: delinea y baja el DEM', 'Hidrología: estaciones + pipeline', 'Cruce: eje-sección y socavación'] },
