...
// ─────────────────────────────────────────────────────────────────────────────
import { SceneView } from './scene_view.js?v=6';
import { toast } from './ui/toast.js?v=6';
import { MapView } from './map_view.js?v=6';
import { Capas } from './capas/capas.js?v=6';
import { loadProject } from './data.js?v=6';
import { HydroPanel } from './hidro/panel.js?v=6';
import { BatiPanel } from './bati/bati_ui.js?v=6';
import { Dock } from './ui/dock.js?v=6';
import { HudManager } from './ui/hud.js?v=6';
import { abrirEstacionHUD } from './datos/estacion_hud.js?v=6';
import { abrirConfigHUD } from './ui/config_ui.js?v=6';
import { generarInforme, generarInformeWord } from './informe/informe.js?v=6';
import { abrirAyudaHUD } from './ui/ayuda.js?v=6';
import { setupMenubar } from './ui/menubar.js?v=6';
import { abrirEmbalseHUD } from './hidro/embalse_ui.js?v=6';
import { abrirAlcantarillaHUD } from './hidraulica/alcantarilla_ui.js?v=6';
import { abrirPuenteHUD } from './hidraulica/puente_presion_ui.js?v=6';
import { abrirEnrocadoHUD } from './hidraulica/enrocado_ui.js?v=6';
import { abrirVerificacionesHUD } from './hidraulica/verificaciones_ui.js?v=6';
import { abrirDegradacionHUD } from './hidraulica/degradacion_ui.js?v=6';
import { abrirRoutingHUD } from './hidro/routing_ui.js?v=6';
import { abrirConvolucionHUD } from './hidro/convolucion_ui.js?v=6';
import { abrirTormentaHUD } from './hidro/tormenta_ui.js?v=6';
import { abrirRedHUD } from './hidro/red_ui.js?v=6';
import { abrirMorfoHUD } from './hidraulica/morfo1d_ui.js?v=6';
import { abrirContinuoHUD } from './hidro/continuo_ui.js?v=6';
import { abrirCalibracionHUD } from './hidro/calibracion_ui.js?v=6';
import { abrirModClarkHUD } from './hidro/modclark_ui.js?v=6';
import { abrirBreachHUD } from './hidro/breach_ui.js?v=6';
import { abrirSismoEstriboHUD } from './hidraulica/sismo_estribo_ui.js?v=6';
import { Flujo2D } from './hidraulica/panel2d.js?v=6';
import { EstructurasPanel } from './estructuras/panel.js?v=6';
import { delinearAuto } from './cuenca/cuenca.js?v=6';
import { delinearEnGrid, morfometria } from './cuenca/delineacion.js?v=6';
import { fetchDEM } from './cuenca/dem_tiles.js?v=6';
import { estacionesCercanas } from './datos/dga.js?v=6';
import { cargarHydroBasins, cuencaHydroBasins } from './cuenca/hydrobasins.js?v=6';
import { extraerRed, trazarCauce } from './cuenca/red_drenaje.js?v=6';
import { routD8 } from './cuenca/delineacion.js?v=6';
import { bus } from './ui/bus.js?v=6';
import { setActivo, infoTipo, getActivo } from './ui/seleccion.js?v=6';
import { curvaAlturaVolumen, vasoANivel } from './hidro/presa.js?v=6';
