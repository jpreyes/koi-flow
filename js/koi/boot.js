...
import { HydroPanel } from './hidro/panel.js?v=14';
...
async function startBoot() {
  ...
  const acciones = {
    ...
    // Menú "Correr": diálogo de pre-vuelo (revisa el plan + lanza el solver).
    'correr-remanso1d': () => import('./ui/correr_ui.js?v=13').then((m) => m.abrirCorrerDialog(window.__koi, 'remanso1d')),
    'difusiva2d': () => import('./ui/correr_ui.js?v=13').then((m) => m.abrirCorrerDialog(window.__koi, 'difusiva')),
    'transiente2d': () => import('./ui/correr_ui.js?v=13').then((m) => m.abrirCorrerDialog(window.__koi, 'transiente')),
