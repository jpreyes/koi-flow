...
// ─────────────────────────────────────────────────────────────────────────────
import { leerDXF, sugerirCapas } from './dxf.js?v=5';
import { construirDEMmetrico } from './interp.js?v=5';
import { demMetricoAGrid, footprint, elevAtMetrico, metricoDesdeLonLat, autoElevar, anclaInicial } from './place.js?v=5';
import { fusionar } from './fusion.js?v=5';
import { detectarSistema } from './proj.js?v=5';
import { nivelNormal } from '../hidraulica/manning.js?v=5';
import { evaluarSocavacion } from '../hidraulica/socavacion.js?v=5';
import { ejeRemanso, ejeMixto } from '../hidraulica/remanso.js?v=5';
import { analisisCompleto, salidaCSV } from '../hidraulica/salida.js?v=5';
import { perfilTransporte } from '../hidro/sedimentos.js?v=5';
import { wktUTM, demArcASCII, sdfGeometria, csvSecciones } from './hecras.js?v=5';
import { exportarDXF } from './dxf_export.js?v=5';
import { fetchDEM } from '../cuenca/dem_tiles.js?v=5';
import { elevAt } from '../hidraulica/secciones.js?v=5';
import { zipStore, descargar } from '../cuenca/exportar.js?v=5';
import { construirMalla2D } from '../hidraulica/malla2d.js?v=5';
import { resolver2D } from '../hidraulica/solver2d.js?v=5';
import { ensureKoiWasm, makeSolverWasm, makePersistentSolverWasm } from '../../lib/portico/wasm_solve.js?v=5';
import { resumenPeligrosidad, exportarCSV, exportarGeoJSON } from '../hidraulica/peligrosidad2d.js?v=5';
import { getConfig } from '../config.js?v=5';
import { setActivo } from '../ui/seleccion.js?v=5';
import { toast, busyStart, busyEnd } from '../ui/toast.js?v=5';
import { stampTerreno, pilaEnSeccion, puntoEnPoligono } from '../estructuras/estructuras.js?v=5';
