...
// ─────────────────────────────────────────────────────────────────────────────
import { estacionesCercanas, cargarSerie } from '../datos/dga.js?v=8';
import { analizar } from '../hidro/frecuencia.js?v=8';
import { correrPipelinePunto } from '../hidro/pipeline.js?v=8';
import { F } from './formulas.js?v=8';
import { figuraCuencaMapa } from './mapa_fig.js?v=8';
...
export async function generarInformeWord(koi) {
  ...
  try {
    ...
    const proj = koi.project || {};
    const { informeADocx } = await import('./docx.js?v=8');
