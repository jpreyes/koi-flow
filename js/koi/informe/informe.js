...
// ─────────────────────────────────────────────────────────────────────────────
import { estacionesCercanas, cargarSerie } from '../datos/dga.js?v=4';
import { analizar } from '../hidro/frecuencia.js?v=4';
import { correrPipelinePunto } from '../hidro/pipeline.js?v=4';
import { F } from './formulas.js?v=4';
import { figuraCuencaMapa } from './mapa_fig.js?v=4';
...
export async function generarInformeWord(koi) {
  ...
  try {
    ...
    const proj = koi.project || {};
    const { informeADocx } = await import('./docx.js?v=4');
