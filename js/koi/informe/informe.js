...
// ─────────────────────────────────────────────────────────────────────────────
import { estacionesCercanas, cargarSerie } from '../datos/dga.js?v=3';
import { analizar } from '../hidro/frecuencia.js?v=3';
import { correrPipelinePunto } from '../hidro/pipeline.js?v=3';
import { F } from './formulas.js?v=3';
import { figuraCuencaMapa } from './mapa_fig.js?v=3';
...
export async function generarInformeWord(koi) {
  ...
  try {
    ...
    const proj = koi.project || {};
    const { informeADocx } = await import('./docx.js?v=3');
